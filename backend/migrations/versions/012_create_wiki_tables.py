"""create canvas, canvas_member, canvas_page tables
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('canvas_id', sa.Integer(), sa.ForeignKey('canvas.canvas_id'), nullable=False),
        sa.Column('parent_page_id', sa.Integer(), sa.ForeignKey('canvas_page.page_id'), nullable=True),
